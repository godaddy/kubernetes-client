...
### apis.admissionregistration.k8s.io.v1alpha1.watch.externaladmissionhookconfigurations(name).get
...
### apis.admissionregistration.k8s.io.v1alpha1.watch.externaladmissionhookconfigurations.get
...
| Parameter | Description |
| --------- | ----------- |
| `body` | #&#x2F;definitions&#x2F;io.k8s.api.admissionregistration.v1alpha1.ExternalAdmissionHookConfiguration |
