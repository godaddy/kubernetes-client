...
### apis.admissionregistration.k8s.io.v1alpha1.watch.initializerconfigurations(name).get
...
### apis.admissionregistration.k8s.io.v1alpha1.watch.initializerconfigurations.get
...
| Parameter | Description |
| --------- | ----------- |
| `body` | #&#x2F;definitions&#x2F;io.k8s.kubernetes.pkg.apis.admissionregistration.v1alpha1.InitializerConfiguration |
