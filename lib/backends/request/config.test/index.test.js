...
describe('Config', () => {
  ...
  describe('.loadKubeconfig', () => {
    const cfgPaths = [
      './lib/backends/request/config.test/fixtures/kube-fixture.yml',
      './lib/backends/request/config.test/fixtures/kube-fixture-two.yml'
    ]
  ...
  describe('.fromKubeconfig', () => {
    ...
    it('load kubeconfig from provided path', () => {
      const args = config.fromKubeconfig('./lib/backends/request/config.test/fixtures/kube-fixture.yml')
