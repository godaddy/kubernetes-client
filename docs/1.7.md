# kubernetes-client (Kubernetes v1.7.13)
...
| [api.v1.namespaces(namespace).limitranges.delete](#apiv1namespacesnamespacelimitrangesdelete) | DELETE /api/v1/namespaces/{namespace}/limitranges |
...
| [api.v1.namespaces(namespace).pods(name).proxy.head](#apiv1namespacesnamespacepodsnameproxyhead) | HEAD /api/v1/namespaces/{namespace}/pods/{name}/proxy |
...
| [api.v1.namespaces(namespace).resourcequotas.post](#apiv1namespacesnamespaceresourcequotaspost) | POST /api/v1/namespaces/{namespace}/resourcequotas |
...
| [api.v1.namespaces(namespace).services(name).proxy(path).put](#apiv1namespacesnamespaceservicesnameproxypathput) | PUT /api/v1/namespaces/{namespace}/services/{name}/proxy/{path} |
...
| [api.v1.nodes(name).proxy(path).patch](#apiv1nodesnameproxypathpatch) | PATCH /api/v1/nodes/{name}/proxy/{path} |
...
| [api.v1.proxy.namespaces(namespace).services(name).patch](#apiv1proxynamespacesnamespaceservicesnamepatch) | PATCH /api/v1/proxy/namespaces/{namespace}/services/{name} |
...
| [api.v1.watch.namespaces(namespace).events(name).get](#apiv1watchnamespacesnamespaceeventsnameget) | GET /api/v1/watch/namespaces/{namespace}/events/{name} |
...
| [apis.admissionregistration.k8s.io.v1alpha1.externaladmissionhookconfigurations.delete](#apisadmissionregistrationk8siov1alpha1externaladmissionhookconfigurationsdelete) | DELETE /apis/admissionregistration.k8s.io/v1alpha1/externaladmissionhookconfigurations |
...
| [apis.apiregistration.k8s.io.v1beta1.watch.apiservices(name).get](#apisapiregistrationk8siov1beta1watchapiservicesnameget) | GET /apis/apiregistration.k8s.io/v1beta1/watch/apiservices/{name} |
...
| [apis.apps.v1beta1.namespaces(namespace).statefulsets(name).patch](#apisappsv1beta1namespacesnamespacestatefulsetsnamepatch) | PATCH /apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name} |
...
| [apis.autoscaling.v1.namespaces(namespace).horizontalpodautoscalers(name).get](#apisautoscalingv1namespacesnamespacehorizontalpodautoscalersnameget) | GET /apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name} |
...
| [apis.batch.v1.get](#apisbatchv1get) | GET /apis/batch/v1/ |
...
| [apis.batch.v2alpha1.namespaces(namespace).scheduledjobs(name).status.put](#apisbatchv2alpha1namespacesnamespacescheduledjobsnamestatusput) | PUT /apis/batch/v2alpha1/namespaces/{namespace}/scheduledjobs/{name}/status |
...
| [apis.extensions.v1beta1.namespaces(namespace).daemonsets(name).patch](#apisextensionsv1beta1namespacesnamespacedaemonsetsnamepatch) | PATCH /apis/extensions/v1beta1/namespaces/{namespace}/daemonsets/{name} |
...
| [apis.extensions.v1beta1.namespaces(namespace).networkpolicies.get](#apisextensionsv1beta1namespacesnamespacenetworkpoliciesget) | GET /apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies |
...
| [apis.extensions.v1beta1.podsecuritypolicies(name).put](#apisextensionsv1beta1podsecuritypoliciesnameput) | PUT /apis/extensions/v1beta1/podsecuritypolicies/{name} |
...
| [apis.networking.k8s.io.v1.namespaces(namespace).networkpolicies.post](#apisnetworkingk8siov1namespacesnamespacenetworkpoliciespost) | POST /apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies |
...
| [apis.rbac.authorization.k8s.io.v1alpha1.clusterrolebindings.delete](#apisrbacauthorizationk8siov1alpha1clusterrolebindingsdelete) | DELETE /apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings |
...
| [apis.rbac.authorization.k8s.io.v1alpha1.roles.get](#apisrbacauthorizationk8siov1alpha1rolesget) | GET /apis/rbac.authorization.k8s.io/v1alpha1/roles |
...
| [apis.rbac.authorization.k8s.io.v1alpha1.watch.roles.get](#apisrbacauthorizationk8siov1alpha1watchrolesget) | GET /apis/rbac.authorization.k8s.io/v1alpha1/watch/roles |
| [apis.rbac.authorization.k8s.io.v1beta1.get](#apisrbacauthorizationk8siov1beta1get) | GET /apis/rbac.authorization.k8s.io/v1beta1/ |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterrolebindings.get](#apisrbacauthorizationk8siov1beta1clusterrolebindingsget) | GET /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterrolebindings.post](#apisrbacauthorizationk8siov1beta1clusterrolebindingspost) | POST /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterrolebindings.delete](#apisrbacauthorizationk8siov1beta1clusterrolebindingsdelete) | DELETE /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterrolebindings(name).get](#apisrbacauthorizationk8siov1beta1clusterrolebindingsnameget) | GET /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterrolebindings(name).put](#apisrbacauthorizationk8siov1beta1clusterrolebindingsnameput) | PUT /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterrolebindings(name).delete](#apisrbacauthorizationk8siov1beta1clusterrolebindingsnamedelete) | DELETE /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterrolebindings(name).patch](#apisrbacauthorizationk8siov1beta1clusterrolebindingsnamepatch) | PATCH /apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterroles.get](#apisrbacauthorizationk8siov1beta1clusterrolesget) | GET /apis/rbac.authorization.k8s.io/v1beta1/clusterroles |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterroles.post](#apisrbacauthorizationk8siov1beta1clusterrolespost) | POST /apis/rbac.authorization.k8s.io/v1beta1/clusterroles |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterroles.delete](#apisrbacauthorizationk8siov1beta1clusterrolesdelete) | DELETE /apis/rbac.authorization.k8s.io/v1beta1/clusterroles |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterroles(name).get](#apisrbacauthorizationk8siov1beta1clusterrolesnameget) | GET /apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterroles(name).put](#apisrbacauthorizationk8siov1beta1clusterrolesnameput) | PUT /apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterroles(name).delete](#apisrbacauthorizationk8siov1beta1clusterrolesnamedelete) | DELETE /apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.clusterroles(name).patch](#apisrbacauthorizationk8siov1beta1clusterrolesnamepatch) | PATCH /apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).rolebindings.get](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolebindingsget) | GET /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).rolebindings.post](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolebindingspost) | POST /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).rolebindings.delete](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolebindingsdelete) | DELETE /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).rolebindings(name).get](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolebindingsnameget) | GET /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).rolebindings(name).put](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolebindingsnameput) | PUT /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).rolebindings(name).delete](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolebindingsnamedelete) | DELETE /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).rolebindings(name).patch](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolebindingsnamepatch) | PATCH /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).roles.get](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolesget) | GET /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).roles.post](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolespost) | POST /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).roles.delete](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolesdelete) | DELETE /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).roles(name).get](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolesnameget) | GET /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).roles(name).put](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolesnameput) | PUT /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).roles(name).delete](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolesnamedelete) | DELETE /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.namespaces(namespace).roles(name).patch](#apisrbacauthorizationk8siov1beta1namespacesnamespacerolesnamepatch) | PATCH /apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.rolebindings.get](#apisrbacauthorizationk8siov1beta1rolebindingsget) | GET /apis/rbac.authorization.k8s.io/v1beta1/rolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.roles.get](#apisrbacauthorizationk8siov1beta1rolesget) | GET /apis/rbac.authorization.k8s.io/v1beta1/roles |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.clusterrolebindings.get](#apisrbacauthorizationk8siov1beta1watchclusterrolebindingsget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/clusterrolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.clusterrolebindings(name).get](#apisrbacauthorizationk8siov1beta1watchclusterrolebindingsnameget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/clusterrolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.clusterroles.get](#apisrbacauthorizationk8siov1beta1watchclusterrolesget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/clusterroles |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.clusterroles(name).get](#apisrbacauthorizationk8siov1beta1watchclusterrolesnameget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/clusterroles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.namespaces(namespace).rolebindings.get](#apisrbacauthorizationk8siov1beta1watchnamespacesnamespacerolebindingsget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/namespaces/{namespace}/rolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.namespaces(namespace).rolebindings(name).get](#apisrbacauthorizationk8siov1beta1watchnamespacesnamespacerolebindingsnameget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/namespaces/{namespace}/rolebindings/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.namespaces(namespace).roles.get](#apisrbacauthorizationk8siov1beta1watchnamespacesnamespacerolesget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/namespaces/{namespace}/roles |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.namespaces(namespace).roles(name).get](#apisrbacauthorizationk8siov1beta1watchnamespacesnamespacerolesnameget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/namespaces/{namespace}/roles/{name} |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.rolebindings.get](#apisrbacauthorizationk8siov1beta1watchrolebindingsget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/rolebindings |
| [apis.rbac.authorization.k8s.io.v1beta1.watch.roles.get](#apisrbacauthorizationk8siov1beta1watchrolesget) | GET /apis/rbac.authorization.k8s.io/v1beta1/watch/roles |
| [apis.settings.k8s.io.get](#apissettingsk8sioget) | GET /apis/settings.k8s.io/ |
| [apis.settings.k8s.io.v1alpha1.get](#apissettingsk8siov1alpha1get) | GET /apis/settings.k8s.io/v1alpha1/ |
| [apis.settings.k8s.io.v1alpha1.namespaces(namespace).podpresets.get](#apissettingsk8siov1alpha1namespacesnamespacepodpresetsget) | GET /apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets |
| [apis.settings.k8s.io.v1alpha1.namespaces(namespace).podpresets.post](#apissettingsk8siov1alpha1namespacesnamespacepodpresetspost) | POST /apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets |
| [apis.settings.k8s.io.v1alpha1.namespaces(namespace).podpresets.delete](#apissettingsk8siov1alpha1namespacesnamespacepodpresetsdelete) | DELETE /apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets |
| [apis.settings.k8s.io.v1alpha1.namespaces(namespace).podpresets(name).get](#apissettingsk8siov1alpha1namespacesnamespacepodpresetsnameget) | GET /apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name} |
| [apis.settings.k8s.io.v1alpha1.namespaces(namespace).podpresets(name).put](#apissettingsk8siov1alpha1namespacesnamespacepodpresetsnameput) | PUT /apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name} |
| [apis.settings.k8s.io.v1alpha1.namespaces(namespace).podpresets(name).delete](#apissettingsk8siov1alpha1namespacesnamespacepodpresetsnamedelete) | DELETE /apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name} |
| [apis.settings.k8s.io.v1alpha1.namespaces(namespace).podpresets(name).patch](#apissettingsk8siov1alpha1namespacesnamespacepodpresetsnamepatch) | PATCH /apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name} |
| [apis.settings.k8s.io.v1alpha1.podpresets.get](#apissettingsk8siov1alpha1podpresetsget) | GET /apis/settings.k8s.io/v1alpha1/podpresets |
| [apis.settings.k8s.io.v1alpha1.watch.namespaces(namespace).podpresets.get](#apissettingsk8siov1alpha1watchnamespacesnamespacepodpresetsget) | GET /apis/settings.k8s.io/v1alpha1/watch/namespaces/{namespace}/podpresets |
| [apis.settings.k8s.io.v1alpha1.watch.namespaces(namespace).podpresets(name).get](#apissettingsk8siov1alpha1watchnamespacesnamespacepodpresetsnameget) | GET /apis/settings.k8s.io/v1alpha1/watch/namespaces/{namespace}/podpresets/{name} |
| [apis.settings.k8s.io.v1alpha1.watch.podpresets.get](#apissettingsk8siov1alpha1watchpodpresetsget) | GET /apis/settings.k8s.io/v1alpha1/watch/podpresets |
| [apis.storage.k8s.io.get](#apisstoragek8sioget) | GET /apis/storage.k8s.io/ |
| [apis.storage.k8s.io.v1.get](#apisstoragek8siov1get) | GET /apis/storage.k8s.io/v1/ |
| [apis.storage.k8s.io.v1.storageclasses.get](#apisstoragek8siov1storageclassesget) | GET /apis/storage.k8s.io/v1/storageclasses |
| [apis.storage.k8s.io.v1.storageclasses.post](#apisstoragek8siov1storageclassespost) | POST /apis/storage.k8s.io/v1/storageclasses |
| [apis.storage.k8s.io.v1.storageclasses.delete](#apisstoragek8siov1storageclassesdelete) | DELETE /apis/storage.k8s.io/v1/storageclasses |
| [apis.storage.k8s.io.v1.storageclasses(name).get](#apisstoragek8siov1storageclassesnameget) | GET /apis/storage.k8s.io/v1/storageclasses/{name} |
| [apis.storage.k8s.io.v1.storageclasses(name).put](#apisstoragek8siov1storageclassesnameput) | PUT /apis/storage.k8s.io/v1/storageclasses/{name} |
| [apis.storage.k8s.io.v1.storageclasses(name).delete](#apisstoragek8siov1storageclassesnamedelete) | DELETE /apis/storage.k8s.io/v1/storageclasses/{name} |
| [apis.storage.k8s.io.v1.storageclasses(name).patch](#apisstoragek8siov1storageclassesnamepatch) | PATCH /apis/storage.k8s.io/v1/storageclasses/{name} |
| [apis.storage.k8s.io.v1.watch.storageclasses.get](#apisstoragek8siov1watchstorageclassesget) | GET /apis/storage.k8s.io/v1/watch/storageclasses |
| [apis.storage.k8s.io.v1.watch.storageclasses(name).get](#apisstoragek8siov1watchstorageclassesnameget) | GET /apis/storage.k8s.io/v1/watch/storageclasses/{name} |
| [apis.storage.k8s.io.v1beta1.get](#apisstoragek8siov1beta1get) | GET /apis/storage.k8s.io/v1beta1/ |
| [apis.storage.k8s.io.v1beta1.storageclasses.get](#apisstoragek8siov1beta1storageclassesget) | GET /apis/storage.k8s.io/v1beta1/storageclasses |
| [apis.storage.k8s.io.v1beta1.storageclasses.post](#apisstoragek8siov1beta1storageclassespost) | POST /apis/storage.k8s.io/v1beta1/storageclasses |
| [apis.storage.k8s.io.v1beta1.storageclasses.delete](#apisstoragek8siov1beta1storageclassesdelete) | DELETE /apis/storage.k8s.io/v1beta1/storageclasses |
| [apis.storage.k8s.io.v1beta1.storageclasses(name).get](#apisstoragek8siov1beta1storageclassesnameget) | GET /apis/storage.k8s.io/v1beta1/storageclasses/{name} |
| [apis.storage.k8s.io.v1beta1.storageclasses(name).put](#apisstoragek8siov1beta1storageclassesnameput) | PUT /apis/storage.k8s.io/v1beta1/storageclasses/{name} |
| [apis.storage.k8s.io.v1beta1.storageclasses(name).delete](#apisstoragek8siov1beta1storageclassesnamedelete) | DELETE /apis/storage.k8s.io/v1beta1/storageclasses/{name} |
| [apis.storage.k8s.io.v1beta1.storageclasses(name).patch](#apisstoragek8siov1beta1storageclassesnamepatch) | PATCH /apis/storage.k8s.io/v1beta1/storageclasses/{name} |
| [apis.storage.k8s.io.v1beta1.watch.storageclasses.get](#apisstoragek8siov1beta1watchstorageclassesget) | GET /apis/storage.k8s.io/v1beta1/watch/storageclasses |
| [apis.storage.k8s.io.v1beta1.watch.storageclasses(name).get](#apisstoragek8siov1beta1watchstorageclassesnameget) | GET /apis/storage.k8s.io/v1beta1/watch/storageclasses/{name} |
| [logs.get](#logsget) | GET /logs/ |
| [logs(logpath).get](#logslogpathget) | GET /logs/{logpath} |
| [version.get](#versionget) | GET /version/ |
