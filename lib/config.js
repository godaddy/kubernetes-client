...
function getInCluster () {
  ...
  const ca = fs.readFileSync(path.join(root, caPath), 'utf8')
  const bearer = fs.readFileSync(path.join(root, tokenPath), 'utf8')
  const namespace = fs.readFileSync(path.join(root, namespacePath), 'utf8')
