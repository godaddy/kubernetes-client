...
function getInCluster () {
  ...
  const ca = path.join(root, fs.readFileSync(caPath, 'utf8'))
  const bearer = path.join(root, fs.readFileSync(tokenPath, 'utf8'))
  const namespace = path.join(root, fs.readFileSync(namespacePath, 'utf8'))
